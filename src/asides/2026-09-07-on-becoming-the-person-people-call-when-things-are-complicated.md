---
title: On Becoming the Person People Call When Things Are Complicated
description: "Vizt Nivlir reflects on an unexpected consequence of competence:
  eventually, people stop asking you to do things and start asking you to look
  at things."
author: Vizt Nivlir
...
tags:
  - post
  - work
image: /assets/asides/vizt-meeting-clients.jpg
imageAlt: One must speak to the humans.
---
There has been a subtle change in the kinds of messages I receive.

They used to contain requests.

*“Can you build this?”*

*“Can you fix this?”*

*“Can you make this slightly larger?”*

The last of these remains distressingly common, but otherwise the pattern has changed.

Increasingly, a message arrives with no obvious request at all. It contains a forwarded email, a screenshot, perhaps a document whose filename includes the word FINAL several times, and a sentence along the lines of: *“Can you have a look at this?”*

I have learned that this can be quite large.
...
Perhaps competence changes how other people perceive you. If you solve enough individual problems, eventually someone assumes you may also be able to identify what the problem is. This seems flattering until you realize that the latter category has no natural boundary.
...
This requires a certain tolerance for not knowing.
...
The problem may still be difficult. But it has become a problem rather than a fog.

I suppose this is why people call.
